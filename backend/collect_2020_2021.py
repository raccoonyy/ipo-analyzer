"""
Collect 2020-2021 IPO data from 38.co.kr
...
def is_target_year(listing_date, target_years=[2019, 2020, 2021]):
...
def main():
    print("=" * 80)
    print("38.CO.KR HISTORICAL IPO DATA COLLECTION (2020-2021)")
    print("=" * 80)
    print("Target years: 2019, 2020, 2021")
    print("Rate limit: 0.6s per request")
    print("HTML Cache: data/cache/38_html/")
    print()
    sys.stdout.flush()

    # IPO number range to search (estimated for 2020-2021)
    start_no = 1400
    end_no = 1650
    ...
    if collected_data:
        ...
        # Save to CSV
        output_file = "data/raw/38_2020_2021.csv"
